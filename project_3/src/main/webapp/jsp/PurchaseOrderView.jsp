				...
				<div class="col-md-4 mb-4">
					<div class="card input-group-addon">
						<div class="card-body">
							...
							%>
							<h3 class="text-center default-text text-primary">Add PurchaseOrder</h3>
							<%
								}
							%>
							<!--Body-->
...
oninput="handleIntegerInput(this, 'totalquantityError', 5)"
										...
										value="<%=DataUtility.getStringData(dto.getTotalquantity()).equals("0.0") ? ""
					: DataUtility.getStringData(dto.getTotalquantity())%>">

								</div>
							</div>							
							<font color="red" class="pl-sm-5" id = "totalquantityError"> <%=ServletUtility.getErrorMessage("totalquantity", request)%></font></br>
							...
							<span class="pl-sm-5"><b>Orderdate</b>
	...
	<div class="col-sm-12">
      <div class="input-group">
        ...
        <input type="text" id="datepicker2" name="orderdate" class="form-control" placeholder="Orderdate" readonly="readonly" value="<%=DataUtility.getDateString(dto.getOrderdate()) %>">
      </div>
    </div>	
	<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("orderdate", request)%></font></br>
							...
							<div class="col-sm-12">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="totalCost"
										...
										value="<%=(DataUtility.getStringData(dto.getTotalCost()).equals("0.0") ? "" : dto.getTotalCost())%>">								</div>
							</div>
							...
							<div class="text-center">
								...
								<input type="submit" name="operation"
									...
									value="<%=PurchaseOrderCtl.OP_UPDATE%>"> <input type="submit"
							...
							<div class="text-center">
								...
								<input type="submit" name="operation"
									class="btn btn-success btn-md" style="font-size: 17px"
									value="<%=PurchaseOrderCtl.OP_SAVE%>"> <input type="submit"
									name="operation" class="btn btn-warning btn-md"
