...
<body class="hm">
	...
	<div>
		<form class="pb-5" action="<%=ORSView.SUPPLIER_LIST_CTL%>"
			...
			%>
			<center>
				<h1 class="text-secondary font-weight-bold pt-3">Supplier
					List</h1>
			</center>
			<div class="row">
		...
		onblur="validateLetterInput(this, 'nameError', 9)"
				...
				<div class="col-sm-2">
					<input type="text" name="paymentterm" placeholder="Enter paymentterm"
						class="form-control" 
				...
				<div class="col-sm-2"><%=HTMLUtility.getList1("category", String.valueOf(dto.getCategory()), map)%></div>



				<div class="col-sm-2">
					<input type="text" name="registrationdate"
						placeholder="Enter registrationdate" id="datepicker2" readonly="readonly"
						class="form-control"
	...
	<div style="margin-bottom: 20px;" class="table-responsive">
		<table class="table table-bSuppliered table-dark table-hover">
			<thead>
			...
			<tbody>
				<tr>
					...
					<td class="text"><a
						href="SupplierCtl?id=<%=dto.getId()%>">Edit</a></td>
				</tr>
			</tbody>
			<%
				}
