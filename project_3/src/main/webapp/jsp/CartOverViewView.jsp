...
<%@page import="in.co.rays.project_3.controller.CartOverViewCtl"%>
...
<body class="hm">
	...
	<main>
	<form action="<%=ORSView.CARTOVERVIEW_CTL%>" method="post">
		<jsp:useBean id="dto"
			...
			<div class="col-md-4 mb-4">
				<div class="card input-group-addon">
					<div class="card-body">
						...
						%>
						<h3 class="text-center default-text text-primary">Add CartOverView
							</h3>
						<%
							}
						%>
						...
						<!-- Input Fields -->
									<!-- Quantity ----------------------------------------------------------------------------------------------------------------------------->
						<span class="pl-sm-5"><b> customerName</b>
		<span style="color: red;">*</span></span> </br>
		<div class="col-sm-12">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text"><i class="fa fa-CartOverView-alt grey-text" style="font-size: 1rem;"></i> </div>
        </div>
	...
	<font color="red" class="pl-sm-5" id = "customerNameError"> <%=ServletUtility.getErrorMessage("customerName", request)%></font></br>
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" class="form-control" 
											...
											value="<%=DataUtility.getStringData(dto.getQuantityOrdered()).equals("0")? "" : DataUtility.getStringData(dto.getQuantityOrdered())%>">

									</div>
								</div>
								<font color="red" class="pl-sm-5" id = "quantityOrderedError"> <%=ServletUtility.getErrorMessage("quantityOrdered", request)%></font></br>
...
<!-- Purchase Date ---------------------------------------------------------------------------------------------------------------------------------->
						...
						<div class="text-center">
							<input type="submit" name="operation"
								...
								value="<%=CartOverViewCtl.OP_UPDATE%>"> <input
								type="submit" name="operation" class="btn btn-warning btn-md"
								value="<%=CartOverViewCtl.OP_CANCEL%>">
						</div>
						<%
							} else {
						%>
						<div class="text-center">
							<input type="submit" name="operation"
								class="btn btn-success btn-md"
								value="<%=CartOverViewCtl.OP_SAVE%>"> <input
								type="submit" name="operation" class="btn btn-warning btn-md"
								value="<%=CartOverViewCtl.OP_RESET%>">
						</div>
						<%
							}
						%>
