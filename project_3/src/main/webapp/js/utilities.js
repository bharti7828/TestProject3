...
function validateAlphaNumericInput(inputElement, errorElementId) {
    const errorMessage = document.getElementById(errorElementId);
    const currentValue = inputElement.value.trim(); // Trim to remove leading and trailing whitespace

    // Regular expression to match exactly 5 alphabetic characters followed by exactly 3 numeric characters
